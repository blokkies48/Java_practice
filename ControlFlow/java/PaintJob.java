...
public class PaintJob {
    public static void main(String[] args) {
        ...
        System.out.println(getBucketCount(20, 4));// 
    ...
    (double width, double height, double areaPerBucket, int extraBuckets){
        ...
        int bucketsNeeded = (int) (areaToPaint / areaPerBucket);
        if (bucketsNeeded < (areaToPaint / areaPerBucket)){
            bucketsNeeded += 1;
        }
    ...
    public static int getBucketCount(double area, double areaPerBucket){
        ...
        if ((int)(area / areaPerBucket) < (area / areaPerBucket)){
            bucketsNeeded += 1;
        }
        return bucketsNeeded;
    }
